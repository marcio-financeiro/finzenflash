...
function selecionarTipo(novoTipo) {
  ...
  document.getElementById('valor-modal-display').classList.toggle('cor-despesa', tipo === 'despesa');
  document.getElementById('valor-modal-display').classList.toggle('cor-receita', tipo === 'receita');
