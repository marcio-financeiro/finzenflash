...
const ICONE_BUSCA = '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3"/></svg>';
  ...
  slot.innerHTML = `
    <div class="rail">
      ...
      <div class="rail-itens">
        ...
        `).join('')}
        <button type="button" class="rail-item" id="btn-abrir-comandos" aria-label="Buscar (Ctrl+K)">
          ${ICONE_BUSCA}
          <span class="rail-tooltip">Buscar (Ctrl+K)</span>
        </button>
      </div>
