...
async function confirmarRestauracao() {
  ...
  try {
    await restaurarBackupCompleto(supabase, usuarioAtual.id, backupCarregado, (tabela) => {
...
async function iniciar() {
  ...
  document.getElementById('btn-cancelar-restaurar').addEventListener('click', () => { backupCarregado = null; fecharModal('modal-confirmar'); });
}
